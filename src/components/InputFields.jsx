    ...
    return (
        <div className='flex flex-row items-center'>
            ...
            <div className='ml-6 flex flex-row gap-2' >
                <button className='text-white text-light px-2  text-lg backdrop-blur-md bg-white/1 hover:bg-white/10'>C</button>
                <p className='text-white text-light  text-lg  '>|</p>
                <button className='text-white text-light px-2  text-lg backdrop-blur-md bg-white/1  hover:bg-white/10'>F</button>
            </div>
        </div>
    );
};
